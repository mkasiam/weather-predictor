...
const AirQuality = ({ airQualityData, cityName }) => {
  ...
  const pollutants = [
    { key: 'co', label: 'Carbon Monoxide (CO)', value: components.co, unit: 'μg/m³' },
    { key: 'no', label: 'Nitrogen Monoxide (NO)', value: components.no, unit: 'μg/m³' },
    { key: 'no2', label: 'Nitrogen Dioxide (NO₂)', value: components.no2, unit: 'μg/m³' },
    { key: 'o3', label: 'Ozone (O₃)', value: components.o3, unit: 'μg/m³' },
    { key: 'so2', label: 'Sulfur Dioxide (SO₂)', value: components.so2, unit: 'μg/m³' },
    { key: 'pm2_5', label: 'Fine Particles (PM2.5)', value: components.pm2_5, unit: 'μg/m³' },
    { key: 'pm10', label: 'Coarse Particles (PM10)', value: components.pm10, unit: 'μg/m³' },
    { key: 'nh3', label: 'Ammonia (NH₃)', value: components.nh3, unit: 'μg/m³' }
  ];
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6">
      ...
      <div className={`${aqiLevel.bgColor} rounded-lg p-6 mb-6`}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-2xl font-bold text-gray-800">AQI: {main.aqi}</div>
        ...
        <p className="text-sm text-gray-700">
          {getAQIDescription(main.aqi)}
        </p>
      </div>

      {/* Pollutant Details */}
      <div className="mb-6">
        <h4 className="font-semibold text-gray-800 mb-4">Pollutant Concentrations</h4>
      ...
      <div className="bg-blue-50 rounded-lg p-4">
        <h4 className="font-semibold text-gray-800 mb-3">Health Recommendations</h4>
        <div className="space-y-2 text-sm text-gray-700">
          ...
          {main.aqi === 3 && (
            <div className="flex items-start gap-2">
              ...
              <span>Sensitive individuals should consider reducing prolonged outdoor activities.</span>
            </div>
          )}
          ...
          {main.aqi >= 4 && (
            <>
              ...
              <div className="flex items-start gap-2">
                <FiAlertTriangle className="text-red-500 mt-0.5 flex-shrink-0" />
                <span>Limit outdoor activities, especially for children and elderly.</span>
              </div>
              <div className="flex items-start gap-2">
                <FiAlertTriangle className="text-red-500 mt-0.5 flex-shrink-0" />
